...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1268: () => globalThis.stopLoading(),
      _1269: () => globalThis.window.navigator.userAgent,
      _1280: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1281: x0 => x0.decode(),
      _1282: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1283: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1286: x0 => x0.send(),
      _1287: () => new XMLHttpRequest(),
      _1288: (x0,x1) => x0.getItem(x1),
      _1290: (x0,x1,x2) => x0.setItem(x1,x2),
      _1291: Date.now,
      _1293: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1294: s => {
      ...
      _1296: () => typeof dartUseDateNowForTicks !== "undefined",
      _1297: () => 1000 * performance.now(),
      _1298: () => Date.now(),
      _1299: () => {
      ...
      _1301: () => new WeakMap(),
      _1302: (map, o) => map.get(o),
      _1303: (map, o, v) => map.set(o, v),
      _1304: x0 => new WeakRef(x0),
      _1305: x0 => x0.deref(),
      _1311: () => globalThis.WeakRef,
      _1316: s => JSON.stringify(s),
      _1317: s => printToConsole(s),
      _1318: (o, p, r) => o.replaceAll(p, () => r),
      _1319: (o, p, r) => o.replace(p, () => r),
      _1320: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1321: s => s.toUpperCase(),
      _1322: s => s.trim(),
      _1323: s => s.trimLeft(),
      _1324: s => s.trimRight(),
      _1325: (string, times) => string.repeat(times),
      _1326: Function.prototype.call.bind(String.prototype.indexOf),
      _1327: (s, p, i) => s.lastIndexOf(p, i),
      _1328: (string, token) => string.split(token),
      _1329: Object.is,
      _1330: (a, i) => a.push(i),
      _1331: (a, i) => a.splice(i, 1)[0],
      _1333: (a, l) => a.length = l,
      _1334: a => a.pop(),
      _1335: (a, i) => a.splice(i, 1),
      _1336: (a, s) => a.join(s),
      _1337: (a, s, e) => a.slice(s, e),
      _1338: (a, s, e) => a.splice(s, e),
      _1340: a => a.length,
      _1342: (a, i) => a[i],
      _1343: (a, i, v) => a[i] = v,
      ...
      _1347: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      ...
      _1350: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1351: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1352: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1354: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1355: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1356: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1357: (t, s) => t.set(s),
      _1359: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1361: o => o.buffer,
      _1362: o => o.byteOffset,
      _1363: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1364: (b, o) => new DataView(b, o),
      _1365: (b, o, l) => new DataView(b, o, l),
      _1366: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1367: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1368: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1369: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1370: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1371: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1372: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1373: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1374: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1375: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1376: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1377: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1380: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1381: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1382: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1383: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1384: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1385: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _3382: () => globalThis.window,
      _3444: x0 => x0.navigator,
      _3708: x0 => x0.localStorage,
      _3833: x0 => x0.userAgent,
      _4041: x0 => x0.length,
...
"https://www.linkedin.com/in/bauer-philipp",
...
"assets/icons/",
"TimelineAxis.",
"The axisPosition must be provided and must be a value between 0.0 and 1.0 inclusive",
"AxisPosition{",
"firstSpace: ",
"objectSpace: ",
"secondSpace: ",
"AxisCoordinates{start: ",
", end: ",
", size: ",
"Either alignTop or alignBottom must be true",
"TimelineAlign.",
"front",
"CardSide.",
"Fill.",
...
"After Effects",
"#00005b",
"https://www.adobe.com/products/aftereffects",
"playstore",
"Play Store",
"ios",
"Web",
...
"Learnings",
"_btnFlipHint",
"_skewCard_24bn78535758",
"flutter.",
"isSeen_24857bh638967hn63",
"Bool",

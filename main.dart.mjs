...
_1586: () => globalThis.stopLoading(),
_1587: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1588: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1589: f => finalizeWrapper(f,x0 => dartInstance.exports._1589(f,x0)),
_1590: (x0,x1,x2) => x0.addEventListener(x1,x2),
_1591: f => finalizeWrapper(f,x0 => dartInstance.exports._1591(f,x0)),
_1592: x0 => x0.send(),
_1593: () => new XMLHttpRequest(),
_1608: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1619: (x0,x1) => x0.getItem(x1),
_1621: (x0,x1,x2) => x0.setItem(x1,x2),
_1622: (x0,x1) => x0.matchMedia(x1),
...
_1670: v => stringToDartString(v.toString()),
_1671: (d, digits) => stringToDartString(d.toFixed(digits)),
_1675: o => new WeakRef(o),
_1676: r => r.deref(),
_1681: Date.now,
...
_1742: (x0,x1) => x0.key(x1),
_1743: (a, i) => a.push(i),
_1744: (a, i) => a.splice(i, 1)[0],
_1746: (a, l) => a.length = l,
_1747: a => a.pop(),
_1748: (a, i) => a.splice(i, 1),
_1750: (a, s) => a.join(s),
_1751: (a, s, e) => a.slice(s, e),
_1752: (a, s, e) => a.splice(s, e),
_1754: a => a.length,
_1756: (a, i) => a[i],
_1757: (a, i, v) => a[i] = v,
_1759: a => a.join(''),
...
_1908: (o, p) => o[p],
_3709: () => globalThis.window,
_3789: x0 => x0.navigator,
_4047: x0 => x0.localStorage,
_4270: x0 => x0.userAgent,
_4488: x0 => x0.length,
_14551: () => globalThis.window,
_14572: x0 => x0.matches,
_14576: x0 => x0.platform,
_14581: x0 => x0.navigator,
_14588: x0 => x0.status,
_14589: (x0,x1) => x0.responseType = x1,
_14591: x0 => x0.response,
_14595: () => globalThis.window.flutterCanvasKit
    };
